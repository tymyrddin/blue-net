...
NetworkMiner and Wireshark have similar base features, but they separate in use  purpose. Although main functions are identical, some features are much stronger for specific use cases.
